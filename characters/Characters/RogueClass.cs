...
namespace characters
{
    public class RogueClass : BaseCharacterClass
    {
        ...
        public RogueClass(string name) : base(name)
        {
            ...
            PrimaryAttributes.Strength = 2.0;
            PrimaryAttributes.Dexterity = 6.0;
        ...
        public override bool EquipWeapon(Weapon weapon)
        {
            try //Try will return TRUE if weapon is the correct type, level and if its equipped on an empty slot for this character.
            {
                ...
                if (weapon.WeaponType == Weapon.TypeOfWeapons.DAGGER || weapon.WeaponType == Weapon.TypeOfWeapons.SWORD)
                {
